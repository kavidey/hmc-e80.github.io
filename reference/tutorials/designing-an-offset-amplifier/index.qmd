...
Referring to the [lab inventory page](reference/inventory/){target="_blank"}, we can see that we can achieve the desired gain by choosing a  $1k\Omega$ resistor for $R_\text{n1}$ and using a 5.1 $k\Omega$ resistor in series with a 200 and 100 $\Omega$ resistor to reach $5.4k\Omega$ for $R_f$.
...
The video below shows you how to build, debug, and simulate the circuit in online circuit simulator [Falstad](https://www.falstad.com/circuit/){target="_blank"}.
