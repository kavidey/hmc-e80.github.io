...
**For software**, you will need to increase the sampling rate of the Teensy.  You can do so following the [`BurstADCSampler` Tutorial](../tutorials/using-burst-sampling/).
