...
These resistors are the ones stocked in the E80 parts boxes (according to the [E12 preferred numbers](https://en.wikipedia.org/wiki/E_series_of_preferred_numbers){target="_blank"}). Many other resistors are available in the analog lab closet.  Don't take resistors (or any other components) from E84 stock.
