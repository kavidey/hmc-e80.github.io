...
::: fragment
Submit key deliverables collected in lab. [Due at the end of your lab section each week (12:15, 5:15 pm).]{style="color:red"}
:::
...
::: fragment
Fill out a survey to help you assess how your team is doing and if there are any issues developing. [We will remind you to complete this at the end of the Writing & Reflection Section on Friday. Due Friday at 3:30 pm.]{style="color:red"}
:::
...
## The point of going to college is to...

::: incremental

::: {.incremental}
1.  Pursue specialized knowledge?
2.  Hone marketable skills to land a high-paying job?
3.  Be exposed to different ways of thinking?
4.  Climb the class ladder and improve your life?
5.  Experiment with who you want to be(come)?
6.  Learn not to fear the unknown?
7.  Build relationships and form a long-lasting network?
8.  Try to make an impact in the world?
:::

**Does generative AI support you achieving any of these goals?**
:::

## AI Usage Policy

In this course, we have two distinct AI policies...

::: columns
::: column
**All Writing and Labs (0-7): **

::: fragment
-   [**AI Level 0: Not Allowed**]{style="color:red"}: The goal of this policy is to encourage you to develop your writing and laboratory skills. We believe that the use of generative AI tools will hinder your learning on these assignments.
:::
:::
...
::: fragment
-   [**AI Level ?: You Decide**]{style="color:orange"}: Soon your team will draft a contract. As part of that exercise you can discuss whether you collectively wish to use generative AI tools for code development during the project phase.
:::
:::
:::
...
-   Feedback Goals: Constructive, specific, actionable. From a place of goodwill to help each other learn and grow.
