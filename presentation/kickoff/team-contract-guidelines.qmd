...
### Contract
[View](./team-contract-template.html){target="_blank"} or [download](./team-contract-template.docx) the team contract template.

### Specs
[View](./team-contract-specs.html){target="_blank"} or [download](./team-contract-specs.docx) the team contract specifications.
