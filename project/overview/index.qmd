...
- **Saturday {{<var dates.dana>}}**  Robot deployment *on Saturday*  at Dana Point. <br> **ALL STUDENTS ARE EXPECTED TO ATTEND THE SATURDAY LAUNCH**
- **Wednesday {{<var dates.poster_session>}}**  Project presentations for all groups during presentation days.
...
* Any sensors, including the ones you've installed or used as part of any of the labs, are fair game for this project. The [reference designs](/reference/design/){target="_blank"} are a good source for sensors.
...
|------|--------------------------------------------------|------------------------------------------------------------------------------|
|  1   | [Navigation Jump Start](/project/navigation){target="_blank"}     | A graded [Submission Sheet](/project/navigation/submission.qmd){target="_blank"}. Submit on Canvas at end of your section |
|  2   | [Breadboard Demo](/project/build){target="_blank"}                | An ungraded, but highly recommended, demo of breadboarded circuits to a prof | 
|  3   | [Soldered Protoboard Demo](/project/build){target="_blank"}       | An ungraded, but highly recommended, demo of soldered circuits to a prof     | 
|  4   | [Deploy Integrated Robot](/project/field){target="_blank"}        | None, though deployment during your section at Phake Lake is the first chance to get data for your report.   | 
|  5   | [Rebuild and Final Deployment](/project/field){target="_blank"}   | None, though deployment *on Saturday* at Dana Point is the second and last chance to get data for your report. | 
|  6   | [Analyze Data](/project/report){target="_blank"}                  | Rough draft of your report. Submit on Canvas on Friday.                      |
|  7   | [Final Poster and Report](/project/report){target="_blank"} | Upload Poster file and report to Canvas by 11:59PM the night before presenting. |
