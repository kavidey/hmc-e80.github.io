...
Specifications: [html](/project/proposal/submission.qmd){target="_blank"} [Word](/project/proposal/submission.docx)

Template: [html](/project/proposal/template.qmd){target="_blank"} [Word](/project/proposal/template.docx)

Examples: [pdf](assets/Project%20Proposal_example_1_.pdf){target="_blank"} [pdf](assets/Project%20Proposal%20_example_2_.pdf)
...
* It should outline your hypothesis and what you're comparing it to: what is the _x_ of your experiment, what is the _y_ and what two _x_-_y_ curves are you comparing? If you need to cite literature to establish your scientific relationship, then don't forget you can access papers through Mudd's network. Also note that there are lots of websites that can help with figuring out important scientific quantities like [wind speed](https://weatherspark.com/h/d/1838/2023/4/20/Historical-Weather-on-Thursday-April-20-2023-in-Dana-Point-California-United-States#Figures-SolarEnergy){target="_blank"}, [harbor depth](https://www.gpsnauticalcharts.com/main/us18746_p1898-dana-point-harbor-nautical-chart.html){target="_blank"} and [water temperature ](https://www.surf-forecast.com/breaks/Dana-Point/seatemp){target="_blank"}, so search carefully to find the expected range of your quantities of interest.
...
* [Water outside the harbor](https://drive.google.com/file/d/0BwiB3SVueuOpV05GVWgtaV9tMFk/view?usp=sharing&resourcekey=0-01dqmgvU3OkorvewX5pyyw){target="_blank"}. We do not allow you to operate a robot here.  Most AUVs will be trashed.
* [Worst case currents close to docks](https://drive.google.com/file/d/0BwiB3SVueuOpUmVjWnM2RUZ6OWM/view?usp=sharing&resourcekey=0-Gw-EZ0-FcsKywoIa2LI3lA){target="_blank"}. No motors are turned on in this video.
* [Normal AUV navigation in the harbor](https://drive.google.com/file/d/0BwiB3SVueuOpa2oyTURlUVFmVkk/view?usp=sharing&resourcekey=0-3BT_e71MRrCcpbY7x37i3w){target="_blank"}.
* [Water clarity](https://drive.google.com/file/d/1D0d_-GQWR-jZdyS6DVEm35iIVWuAI0Vb/view?usp=sharing){target="_blank"}.
:::

## Budget

You must prepare a budget for your final project.  **You have $50 to spend** on the project, and you may not augment that amount with personal money, student project grants or any other source of funds.  Your budget only needs to include sensors and other parts (e.g.: motors) that we don't have in stock, and it should exclude parts that you plan to use from our [inventory](/reference/inventory){target="_blank"}, which is freely available to you.  
...
Common vendors include [Digikey](http://www.digikey.com/){target="_blank"}, [McMaster-Carr](https://www.mcmaster.com/){target="_blank"}, [JameCo](http://www.jameco.com/){target="_blank"}, [SparkFun](https://www.sparkfun.com/){target="_blank"}, [AdaFruit](https://www.adafruit.com/){target="_blank"} and many others.
...
2. Prepare a purchase order: 
    - [New Purchase Order Request Form](https://www.hmc.edu/engineering/current-student-information/department-forms/){target="_blank"}
...
Make a schematic that adheres to good practice (as outlined in [lab 3 specs](/labs/lab3/submission.qmd){target="_blank"}) and that includes all of your sensor interface circuits. Your schematic should be a comprehensive design document, so do the following: 
...
All of your new electronics will be assembled on a new board called the [protoboard](https://drive.google.com/open?id=1VT_N11I8Alo8cQPUag5moUuXnGed80gd){target="_blank"}.  We discuss the protoboard in greater detail during the project [build](/project/build){target="_blank"}, but its limited size should inform your circuit design.  The protoboard has the same number of rows as a standard breadboard, so don't pick designs that require more wires than would fit on a breadboard. As a reminder, you can find the design details for all the PCBs you will use on the [boards](/reference/board){target="_blank"} page, and those design details can help when planning out your final project. 
