...
- [Github]({{<var github-url>}}): This is our Github repository, which lets you use Git to access E80 software. Git is a distributed version control system that allows you to copy source code and track changes to the code. [Lab 0](/labs/lab0){target="_blank"} will walk you through the steps to configure Git on your computer.
...
Each student will write an individual technical memorandum on material covered in Lab 6. See the [Lab 6](labs/lab6){target="_blank"} page for more information.  
...
Each team will prepare a poster to be presented during the E80 poster session during Presentation days on {{<var dates.poster_session>}}. Guidelines for the poster along with a rubric will be posted later in the semester on the [Final Project Report and Poster page](/project/project/){target="_blank"}.

#### Final Report

A final technical report detailing the results of the final AUV deployment will be submitted by each individual student.
The report will be graded for both technical content and proper use of [technical English](https://www.mit.edu/course/21/21.guide/){target="_blank"}.
