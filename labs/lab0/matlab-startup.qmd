...
1.  A screenshot showing you've completed the assigned sections of the [MATLAB On-ramp tutorial](#matlab-onramp){target="_self"}.
2.  A screenshot of your completed `debugme.m` script file.
3.  A brief, 2-3 sentence reflection detailing something you learned from the [plotting question](#matlab-plotting-video){target="_self"}.
4.  A brief, 4-5 sentence reflection detailing something you learned from the [debugging practice](#practice-debugging-in-matlab){target="_self"}.
...
1.  Navigate to the [MATLAB Onramp self-paced online course](https://matlabacademy.mathworks.com/details/matlab-onramp/gettingstarted). You will need to login using the account that you created earlier.
...
Watch [this second 17-minute video](https://vimeo.com/501103844) to learn how to find and fix errors in your MATLAB code.
