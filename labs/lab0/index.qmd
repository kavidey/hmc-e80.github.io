...
3. One team member should solder header pins to the Teensy. **Teensys are in limited supply**, so practice soldering. Use the reference images below as a guide, and make sure your pins are oriented as indicated in the references before you solder. 
