...
3. [How to build a 555 Timer circuit](https://www.youtube.com/watch?v=Vbz_MKT7KnI). As you watch the video and build the circuit, identify how each connection you make is represented in the circuit diagram linked [here](https://www.elprocus.com/blinking-led-using-555-timer-ic/). Here is a [video on how the 555 works.](https://www.youtube.com/watch?v=i0SNb__dkYI) 
...
1. Review a helpful video on how to solder, found [here](https://www.youtube.com/watch?v=Qps9woUGkvI).
...
Follow the [setup instructions](https://github.com/HMC-E80/E80?tab=readme-ov-file#how-to-use-this-repository) in the README of the [E80 GitHub page](https://github.com/HMC-E80/E80-SP2023#git-setup).
...
4. Change the Arduino IDE Sketchbook location to the E80 Github folder, which you downloaded earlier in the section, by using `File->Preferences`. 
...
4. Select “Individual” license.
5. On the product selection screen, select the following toolboxes (which you'll need for E72):
...
- [inf004.txt](./assets/INF004.TXT){download="inf004.txt"}
- [log004.bin](./assets/LOG004.BIN){download="log004.bin"}
