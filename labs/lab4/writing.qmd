...
See the [references section](#references){target="_self"} below for more information on how to correctly format the citations.
...
In this lab, we will use IEEE citation style, which includes a concise and clear way of listing references.
