...
5. Build an MPX5700 on your breadboard, and test that it works using a multimeter and a water column in a graduated cylinder.  Section 7 in these [instructions from E79](https://sites.google.com/g.hmc.edu/e79-practicum/module-2/practicum-2d) might help.
6. Connect your MPX5700 to your op-amp circuit and test the assembled pressure sensor using a water column in a graduated cylinder.
7. In a table, record values of depth, predicted voltage, measured voltage, percent error between the predicted and measured voltages, and estimated pressure.
8. Plot a depth vs. voltage calibration curve, and include regression lines and appropriate measures of uncertainty.
...
3. Prepare a set of six different temperature baths between 0 °C and 80 °C.  You will only have access to a few insulated beakers to prepare these baths, so you may need to prepare them in batches or wait for the first baths you made to cool a bit in order to get extra data points.
...
6. Plot the data points (T vs. R), and the non-linear Steinhart-Hart fit (See code under **non-linear fit** and **non-linear residuals**).
...
2. Obtain a digital thermometer to use for "ground truth" temperature measurements.
3. Prepare a set of six different temperature baths between 0 °C and 80 °C.  As in section @sec-therm, you may be limited by the number of insulated beakers available, so you can prepare the baths in batches or wait for them to cool down between measurements.
