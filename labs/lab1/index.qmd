...
Prelab Help Sheet: [html](./prelab.qmd){target="_blank"}
...
Be sure to read the [Lab Overview](../overview/index.qmd){target="_blank"} to learn about safety requirements, expensive equipment handling and other rules.  You must review all SAFETY QUESTION boxes below as part of pre-lab.  If you ever reach a safety question box and either can't answer it or feel unsure, grab an instructor.
...
4. Follow the instructions in the [Motherboard Assembly Document](https://docs.google.com/document/d/1v1vE3GXXUw8o6T2IJJws_xr_b3ntKiPx/edit?usp=sharing&ouid=105511935419108795487&rtpof=true&sd=true){target="_blank"} to build your Motherboard.
5. Cover the back of your motherboard with insulating foam sheet using these [instructions](https://drive.google.com/open?id=1x0CMBDFia2uY5qxPkWFfg_pN3FcR7Pth){target="_blank"} to prevent inadvertent short circuits when you set it down. 
...
* The schematic for the motherboard is [here](https://drive.google.com/file/d/1pk_mORYsxhedKjjqzhMrxj9H5ZVH3zqp/view?usp=sharing){target="_blank"}, 
* The layout for the motherboard is [here](https://drive.google.com/file/d/1pmm8xwpyAHAL5YvwMIQma4W8DuV-MP31/view?usp=sharing){target="_blank"}. 
* [KiCAD](https://www.kicad.org/) design files are  [here](https://drive.google.com/file/d/1pi9WNW7WoIx80xgb_0LWSUyA-LMfp94Z/view?usp=sharing){target="_blank"}.


You can find reference information for all of the E80 boards summarized on [this page](/reference/board){target="_blank"}
:::


## Motherboard Validation, IMU Calibration, and IMU Error Measurement

Your motherboard has a circuit on it called an inertial measurement unit (IMU), specifically an [LSM303AGRTR](https://www.st.com/content/ccc/resource/technical/document/datasheet/74/c4/19/54/62/c5/46/13/DM00177685.pdf/files/DM00177685.pdf/jcr:content/translations/en.DM00177685.pdf){target="_blank"}, which allows you to measure acceleration and magnetic fields. This is a useful sensor that we will explore more later in the course. We are just getting started with the sensor in this section by  calibrating the output and measuring its noise statistics.  This sensor is also useful because you can only measure its output if your motherboard is working correctly. The tests in this section will ensure that your Teensy can listen to the IMU, write to the SD card, and drive the motors.
...
7. Take the INF and BIN files off of the SD card and read them according to the following instructions. 
    ...
    iii) These links provide [sample INF](../lab0/assets/INF004.TXT) and [sample BIN](../lab0/assets/LOG004.BIN) files so you can test the MATLAB scripts during prelab. The sample file is very noisy, so it can't be used to find answers to the questions later in this Section.
...
9. Verify that your motherboard can drive motors by attaching motors to motor ports A, B and C, then modifying and running `E80_Lab_01.ino` (which you [set up in lab 0](https://hmc-e80.github.io/E80/labs/lab0/#arduino-practice){target="_blank"}) to drive each of them. If your motors are not ready, you can measure the voltages at screw terminals A, B and C to observe whether they are being correctly applied by your software.
...
1. You will need a total of 3 motors. If necessary, you can prep new motors as you did in E79, but your time will be very limited if you must build motors. Instructions can be found [here](https://sites.google.com/g.hmc.edu/e79-practicum/module-1/practicum-1a){target="_blank"}.
...
3. Solder the leads of your three motors.  Your motors will be OUTSIDE of the box, so your solder joints will need to be waterproofed with heat shrink tubing. After putting heat shrink on your wires, solder the motor leads to the twisted pair on the non-threaded side of your penetrator bolt. Finish Waterproofing your solder joints with heat shrink tubing. 
