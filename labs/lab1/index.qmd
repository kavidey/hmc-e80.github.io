...
Be sure to read the [Lab Overview](../overview/index.qmd) to learn about general rules, safety requirements, expensive equipment handling and other rules.  You must review all warning callout boxes as part of pre-lab.  If you ever reach a warning box and feel unsure about its contents, grab an instructor.
