...
-   Refer to previous E80 writing assignments for guidelines on how to write high-quality versions of the various sections needed.
    -   [Lab 1: Figures](../lab1/writing.qmd){target="_blank"}
    -   [Lab 2: Tables](../lab2/writing.qmd){target="_blank"}
    -   [Lab 3: Schematics and Mechanical Drawings](../lab3/writing.qmd){target="_blank"}
    -   [Lab 4: Introductions](../lab4/writing.qmd){target="_blank"}
    -   [Lab 5: Mathematical Derivations and Equations](../lab5/writing.qmd){target="_blank"}
-   Short tech memo from Prof. Spjut ([link](https://drive.google.com/file/d/1wtEeyfcI0ObH-54Jn9V4pzgGdI38T4-9/view?pli=1){target="_blank"})
