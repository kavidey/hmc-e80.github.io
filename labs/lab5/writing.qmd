...
-   This document is a great place to start: “[How to Use Mathematical Equations in Your Thesis](https://gradstudents.carleton.ca/2014/use-mathematical-equations-thesis/){target="_blank"}”, by Rozita Rashtchi.
...
-   Pages 4-8 of the “[User’s Guide for the `amsmath` Package](https://texdoc.org/serve/amsldoc.pdf/0){target="_blank"}"