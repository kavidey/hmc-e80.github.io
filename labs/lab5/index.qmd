...
This is a rotation lab, so not all teams will be working on this lab in the same week.  Odd numbered teams (11, 23, 35, etc.) will do this lab in week 6, while Even numbered teams (12, 24, 36, etc.) work on [Lab 6](../lab6/index.qmd){target="_blank"}.  Even numbered teams  will do this lab in week 7, while Odd numbered teams work on lab 6.  Be sure to watch the correct videos, do the correct quiz, and put in prelab effort for the correct lab!

## Introduction to the FFT

The oscilloscope ( [Agilent/Keysight 2024A](http://literature.cdn.keysight.com/litweb/pdf/75015-97045.pdf){target="_blank"}, [spec sheet](http://literature.cdn.keysight.com/litweb/pdf/5990-6618EN.pdf){target="_blank"}) has a feature that allows it to display a live FFT of a signal on one of the channels.  In this section we're going to use that feature to study the basic behavior of the FFT and to examine the effect of windowing on real world data.  **The whole team should participate in this section, at minimum by watching.**  Much of this section can be predicted and analyzed very accurately in prelab with sample data generated in MATLAB.
...
You will need to use microphones to pick up sounds in the tank. We will be using a waterproof electret microphone called the [CME-1538-100LB](http://www.cui.com/product/resource/cme-1538-100lb.pdf){target="_blank"}. 
...
The electret microphone output is small (generally 10s of mV depending on the sound) and zero centered, so you will need to amplify the tank signals to see them your oscilloscope.  Designing an amplifier is trickier than you'd expect because of an op-amp parameter called the [Gain-Bandwidth product](https://en.wikipedia.org/wiki/Gain%E2%80%93bandwidth_product){target="_blank"}.
...
3. Use the [E80_Lab05_Teensy_Rig.m](https://github.com/HMC-E80/E80-SP2023/blob/main/MATLAB/E80_Lab_05_Teensy_Rig.m){target="_blank"} software to measure vectors of sample data with sample rates of 10 kS/s and 100 kS/s (kilosamples per second).
